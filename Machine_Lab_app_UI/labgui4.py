...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonGroup.addButton(self.MOTOR1action)
        self.buttonGroup.addButton(self.MOTOR2action)
        self.buttonGroup.addButton(self.MOTOR3action)
        self.buttonGroup.addButton(self.MOTOR4action)
        self.MOTOR1action.setAutoExclusive(True)
        self.MOTOR2action.setAutoExclusive(True)
        self.MOTOR3action.setAutoExclusive(True)
        self.MOTOR4action.setAutoExclusive(True)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(325, 490, 71, 243))
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(585, 490, 71, 243))
        ...
        self.layoutWidget_3.setGeometry(QtCore.QRect(805, 490, 71, 243))
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(105, 490, 71, 243))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Diagram"))
        self.MOTOR1action.setText(_translate("Dialog", "M1OTOR"))
        self.MOTOR2action.setText(_translate("Dialog", "M2OTOR"))
        self.MOTOR3action.setText(_translate("Dialog", "M3OTOR"))
        self.MOTOR4action.setText(_translate("Dialog", "M4OTOR"))
